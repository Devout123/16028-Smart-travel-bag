...
/* {
{
  "ProductKey": "a1QpdDavas4",
  "DeviceName": "MCU_to_app",
  "DeviceSecret": "12b2eb2692f120f1b527a167a52c7d91"
}
{
  "ProductKey": "a1F0vOig60x",
  "DeviceName": "dht22",
  "DeviceSecret": "a0b356a43bdaa55a8d35040934ac3ce8"
}
}
*/
#define  PRODUCTKEY           "a1QpdDavas4"                                        //产品ID
#define  PRODUCTKEY_LEN       strlen(PRODUCTKEY)                                   //产品ID长度
#define  DEVICENAME           "MCU_to_app"                                               //设备名  
#define  DEVICENAME_LEN       strlen(DEVICENAME)                                   //设备名长度
#define  DEVICESECRE          "12b2eb2692f120f1b527a167a52c7d91"                   //设备秘钥   
#define  DEVICESECRE_LEN      strlen(DEVICESECRE)                                  //设备秘钥长度
#define  S_TOPIC_NAME         "/a1QpdDavas4/MCU_to_app/user/get"   //需要订阅的主题  
#define  P_TOPIC_NAME         "/a1QpdDavas4/MCU_to_app/user/update"    //需要发布的主题     
